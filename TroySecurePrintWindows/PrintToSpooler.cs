...
namespace TroySecurePortMonitorUserInterface
{
    public class PrintToSpooler
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount, string szDocName)
        {
            ...
            di.pDocName = szDocName; //***KLK  MAKE THIS DOC NAME MATCH A CONFIGURED NAME TO GET IT TO THE PRINTER
            di.pDataType = "RAW";
        ...
        {
            // Open the file.
            FileStream fs = new FileStream(szFileName, FileMode.Open, FileAccess.ReadWrite, FileShare.None);
