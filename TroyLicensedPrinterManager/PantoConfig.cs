...
namespace TroyLicensedPrinterManager
{
    public partial class PantoConfig : Form
    {
        ...
        {
            string ConfigPath = CommonPath + @"\Configuration";
        ...
        private void cboModels_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                string pgFileName = CommonPath + @"\Configuration\" + cboModels.Text + @"\TroyPantographConfiguration.xml";
                if (!File.Exists(pgFileName))
                {
                    pgFileName = CommonPath + @"\Configuration\TroyPantographConfiguration.xml";
                }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            if (ValidateSettings())
            {
                ...
                if (sc.SaveLocation != "")
                {
                    ...
                    string configloc = CommonPath + @"\Configuration\" + sc.SaveLocation;
                    ...
                    for (int cntr = 0; cntr < 4; cntr++)
                    {
                        ...
                        pBuilder.CreatePantographPcl(pfilename, swPantograph.PantographConfigurations[cntr], CommonPath + @"\Configuration\", true);
                    }
